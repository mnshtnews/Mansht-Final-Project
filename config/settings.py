...
PRIORITY_THRESHOLD_FACEBOOK:  int = 9    


INSTAGRAM_MIN_INTERVAL_SECONDS: int = 120  
TWITTER_MIN_INTERVAL_SECONDS:   int = 60    
FACEBOOK_MIN_INTERVAL_SECONDS:  int = 300   

FACEBOOK_MAX_PER_HOUR:  int = 10  
TWITTER_MAX_PER_HOUR:   int = 25   
INSTAGRAM_MAX_PER_HOUR: int = 10   
